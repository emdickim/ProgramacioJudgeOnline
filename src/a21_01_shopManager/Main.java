    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (opcio) {
                ...
                case 2 -> System.out.println(shop.numProducts());
                case 3 -> {
                    ...
                    boolean isActive = switch (scanner.nextInt()) {
                            case 1 -> true; 
                            case 2 -> false; 
                            default -> true;
                    };
                    ...
                    System.out.println(shop.addProduct(new Product(name, size, price, isActive)));
                }
                case 4 -> {
                    ...
                    scanner.nextLine();
                    System.out.println(shop.updateProduct(id, new Product(name, size, price, isActive)));
                }
                case 5 -> {
                    System.out.println("Enter ID:");
                    int id = scanner.nextInt();
                    scanner.nextLine();
                    System.out.println(shop.removeProductById(id));
                }
            }
        }
    }
